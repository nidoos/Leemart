...
<body>
    <div class="wrap">
                        ...
                        <nav class="nav_list">
                            <ul class="list">
                                <div class="table-wrapper">
                                    <h2 align = "center" style = "font-size: 100px; color: #fff;">PAYMENT</h2>
                                    <table class = "fl-table" style="margin-top: 50px;" style="height:30vh; width:50vw">
		...
		%>
                                        ...
                                        <tr>
                                        	<td></td>
											<td colspan="2" align="right" id ="toto">총액 : <%=total%>원</td>
											<td colspan="1" align = "right" bgcolor="#111111""><button onclick="final_c()" style="color: #FFFFFF" >결제</button></td>
										</tr>
                                        </tbody>
